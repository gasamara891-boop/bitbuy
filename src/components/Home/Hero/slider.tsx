...
/*
  Fixes applied:
  - Wrapped the Slider in a container with overflow-hidden to prevent the slick-track
    from pushing the page width.
  - Ensured each slide is a responsive, full-width item (className="w-full") so slick-track
    width is constrained to the visible area.
  - Removed any fixed/extra widths on slide wrappers that could accumulate and cause overflow.
  - Added responsive spacing using padding inside slide content rather than slide wrapper margin/padding.
  - Added className="w-auto h-auto" to <Image /> to preserve aspect ratio and silence the
    Next/Image warnings about modifying only one dimension.
  - Kept slider responsive settings but ensured slidesToShow values match breakpoints and slides are not variableWidth.
*/
