...
const DEFAULT_STATS: Stat[] = [
  { id: "total_invested", label: "Total Invested", value: 8500000, prefix: "$", format: "compact", decimals: 1 },
  { id: "active_investors", label: "Active Investors", value: 23000, suffix: "+", format: "compact", decimals: 0 },
  { id: "total_profit", label: "Total Profit", value: 9200000, prefix: "$", format: "compact", decimals: 1 },
  { id: "total_plans", label: "Active Plans", value: 15, format: "full", decimals: 0 },
];
